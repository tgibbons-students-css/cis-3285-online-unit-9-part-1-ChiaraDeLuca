...
namespace SingleResponsibilityPrinciple
{
    public class TradeProcessor
    {
        ...
        private bool ValidateTradeData(string[] fields, int currentLine)
        {
            ...
            //Request 403 - "As a Traders I want to prevent dangerous trades so that 
            //   one typo doesn't ruin the company."  Details: Trade amounts must be
            //  between 1,000 and 100,000 units.If the trade is outside these bounds 
        ...
        // Request  405 - "As a manager, I want to easily monitor the trading 
        //errors my traders make so I can provide them better training to avoid 
        // errors." Details: all logs should be sent to an XML file along with
